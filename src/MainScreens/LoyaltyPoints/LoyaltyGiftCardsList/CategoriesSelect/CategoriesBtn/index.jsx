...
import CategorySvg from '../../../../../assets/loyaltyPoints/giftCards/category.svg';
...
const CategoriesBtn = ({openModal}) => {
    ...
    return (
        <TouchableOpacity style={[
             ...
             <CategorySvg color={colors.loyaltyPrimary}/>

             <TypographyText 
                title={t('LoyaltyGiftCards.categories')}
