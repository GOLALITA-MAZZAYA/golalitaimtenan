...
import { getLoyaltyProductsHistory} from "../../../../api/loyalty";
...
const HistoryTab = () => {
  const {isLoading,  isError, data, error } = useQuery(["products-history"], getLoyaltyProductsHistory
  ...
  console.log(data,'products history')
